...
public class Database {
    ...
    private Integer kitchen,dead_people,hotel_rooms,floors,parking,workplace,constantly_at_facility,periodically_at_facility,
            fixed_violations,no_fixed_violations,injured_people,seats,books_storage;
    private Float height_object,losses,tax_free_income,volume_premises,volume_rooms_a,volume_rooms_б,volume_rooms_в,volume_rooms_г,square,square_technical_premises;
